...
class Date {
  ...
  public static boolean isValidDate(int month, int day, int year) {
    if( month >= 1 && month <= 12 && day > 0 && day <= daysInMonth(month,year) && year > 0) return true;
    else return false;                        // replace this line with your solution
  }
  ...
  public boolean isAfter(Date d) {
    ...
    else return !this.isBefore(d); // replace this line with your solution
  }
  ...
  public int difference(Date d) {
    ...
    if(isAfter(d)) {
        ...
        diff = diff + d.dayInYear() - dayInYear();
        diff = -diff;
    }
  ...
  public static void main(String[] argv) {
    ...
    System.out.println("\nTesting isLeapYear.");
    System.out.println("2000 is a leapyear should be true; " + isLeapYear(2000));
    System.out.println("1900 is a leapyear should be false; " + isLeapYear(1900));
    System.out.println("2004 is a leapyear should be true; " + isLeapYear(2004));
    System.out.println("2001 is a leapyear should be false; " + isLeapYear(2001));
