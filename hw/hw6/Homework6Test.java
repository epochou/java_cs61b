...
public class Homework6Test {
  ...
  public static void main(String[] args) {
    ...
    while( count < args.length ) {
      numBoards = Integer.parseInt(args[count]);
      ...
      for( int i = 0; i < table.bucketSize(); i++ ) {
          System.out.print("[" + table.bucket()[i].length() + "]");
          if( (i+1) % 10 == 0 ) {
              System.out.println();
          }
      }
      System.out.println();
      System.out.println( "Expected collisions: " + table.ExpectedCollisions() );
      System.out.println( "Actual collisions: " + table.numberOfCollisions() );
      System.out.println();
        count++;
    }
